...
function read_database()
{
  ...
  $printer_configs = $file ? json_decode($file, true) : null;
  return empty($printer_configs) ? ['printers' => [], 'order_printers' => [], 'receipt_printer' => ""] : $printer_configs;
}

function get_printers()
{
  $printer_configs = read_database();
